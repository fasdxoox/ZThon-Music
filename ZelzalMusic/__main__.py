...
async def init():
    ...
    LOGGER("ميـوزك لـول").info("تم تحميل الاضافات ...✓")
    await userbot.start()
    await Zelzaly.start()
    try:
        await Zelzaly.stream_call("https://telegra.ph/file/4e4e5d9294df98ed1f233.jpg")
    except NoActiveGroupCall:
        LOGGER("ميـوزك لـول").info(
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("ميـوزك لـول").info("جارِ ايقاف بوت الميوزك . . .")
